...
// Migration to add Cars, Motorcycles, E-Bikes, and Caravans tables to trucks.db

db.serialize(() => {
  console.log('🚗 Creating Cars table in trucks.db...');
  ...
  console.log('🏍️ Creating Motorcycles table in trucks.db...');
  ...
  db.run(`
    CREATE TABLE IF NOT EXISTS motorcycles (
      ...
      -- Bike Details
      type VARCHAR(50), -- Sport, Touring, Cruiser, Adventure, Naked, Dual Sport, Scooter, Electric
      ...
      fuel_type VARCHAR(50), -- Petrol, Electric, Hybrid
      ...
      navigation BOOLEAN DEFAULT 0,
      bluetooth BOOLEAN DEFAULT 0,
  ...
  console.log('🚴 Creating E-Bikes table in trucks.db...');
  ...
  console.log('🚐 Creating Caravans table in trucks.db...');
  ...
  const indexes = [
    ...
    'CREATE INDEX IF NOT EXISTS idx_ebikes_year ON ebikes(year)',
    ...
    'CREATE INDEX IF NOT EXISTS idx_caravans_model ON caravans(model)',
